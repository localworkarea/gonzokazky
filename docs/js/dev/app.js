...
}, _clamp$2 = function _clamp2(min, max, value) {
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var _win$3, _doc$3, _docElement, _pluginInitted, _tempDiv, _recentSetterPlugin, _reverting, _windowExists$2 = function _windowExists22() {
  return typeof window !== "undefined";
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var gsap, _coreInitted, _win, _doc, _docEl, _body, _toArray, _clamp, ScrollTrigger, _mainInstance, _expo, _getVelocityProp2, _inputObserver2, _context, _onResizeDelayedCall, _windowExists3 = function _windowExists4() {
  return typeof window !== "undefined";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function createAnimation() {
    ...
    if (sectionTwoPricture) {
      gsapWithCSS.to(sectionTwoPricture, {
        opacity: 1,
        scrollTrigger: {
          trigger: ".section-2",
          start: "top bottom",
    ...
    mm.add(
      ...
      (context3) => {
        const { pc, mob } = context3.conditions;
